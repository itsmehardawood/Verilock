...
// import { X, ExternalLink, AlertCircle, Shield, Calendar, Users, MapPin, CheckCircle, XCircle } from 'lucide-react';
...
//       {/* Background overlay - moved outside the centering container */}
//       <div 
...
//         {/* Modal content */}
//         <div className={`inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle w-full ${sizeClasses[size]} relative z-10`}>
//           {/* Header */}
