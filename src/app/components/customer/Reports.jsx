...
// import { FileText, Download, Eye, Filter, Calendar, Search, AlertCircle, CheckCircle, XCircle, TrendingUp } from 'lucide-react';
...
//     const matchesSearch = report.profileName.toLowerCase().includes(searchQuery.toLowerCase()) ||
...
//         <p className="text-gray-600 mt-1">View and download detailed scan reports</p>
//       </div>
...
//           <div className="flex items-center justify-between">
//             <div>
//               <p className="text-sm text-gray-600">No Risk</p>
//               <p className="text-2xl font-bold text-green-600 mt-1">79</p>
//             </div>
...
//               className="w-full text-gray-600 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
//             />
//           </div>
//         </div>
...
//                   <td className="px-6 py-4 whitespace-nowrap">
//                     <div>
//                       <div className="text-sm font-medium text-gray-900">{report.profileName}</div>
//                       <div className="text-sm text-gray-500">{report.profileUrl}</div>
//                     </div>
//                   </td>
//                   <td className="px-6 py-4 whitespace-nowrap">
//                     <span className="text-sm text-gray-900">{report.platform}</span>
//                   </td>
//                   <td className="px-6 py-4 whitespace-nowrap">
...
//                       report.fakesFound > 5 ? 'bg-red-100 text-red-800' :
//                       report.fakesFound > 0 ? 'bg-yellow-100 text-yellow-800' :
