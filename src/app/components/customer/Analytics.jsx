...
//           <p className="text-gray-400 mt-1">Track detection performance and insights</p>
//         </div>
...
//           <p className="text-3xl font-bold text-gray-800 mt-1">387</p>
...
//             </span>
//           </div>
//           <h3 className="text-gray-600 text-sm font-medium">Fakes Detected</h3>
...
//           <p className="text-3xl font-bold text-gray-800 mt-1">97%</p>
...
//           <p className="text-3xl font-bold text-gray-800 mt-1">2.3s</p>
...
//             <div>
//               <h2 className="text-lg font-bold text-gray-800">Scan Trends</h2>
//               <p className="text-sm text-gray-600">Monthly scans vs fakes found</p>
//             </div>
//           </div>
...
//               <p className="text-sm text-gray-600">Scans by social media platform</p>
//             </div>
//           </div>
//           <ResponsiveContainer width="100%" height={300}>
//             <PieChart>
...
//               <p className="text-sm text-gray-600">Scans and blocks this week</p>
//             </div>
//           </div>
//           <ResponsiveContainer width="100%" height={300}>
...
//           <div className="flex items-center justify-between mb-6">
//             <div>
//               <h2 className="text-lg font-bold text-gray-800">Risk Level Distribution</h2>
//               <p className="text-sm text-gray-600">Profiles categorized by risk</p>
//             </div>
//           </div>
//           <ResponsiveContainer width="100%" height={300}>
//             <PieChart>
...
//         <div className="flex items-center justify-between mb-6">
//           <div>
//             <h2 className="text-lg font-bold text-gray-800">Detection Accuracy Over Time</h2>
//             <p className="text-sm text-gray-600">AI model performance improvement</p>
//           </div>
//         </div>
//         <ResponsiveContainer width="100%" height={300}>
